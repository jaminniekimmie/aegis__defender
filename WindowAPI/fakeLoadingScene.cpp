...
HRESULT fakeLoadingScene::init(void)
{
...
void fakeLoadingScene::release(void)
{
}

void fakeLoadingScene::update(void)
{
...
void fakeLoadingScene::render(void)
{
...
void fakeLoadingScene::frameChange()
{
	_count++;
	if (_count % 5 == 0)
	{
