...
HRESULT loadingCharScene::init(void)
{
	...
	_player[CLU].img = IMAGEMANAGER->addFrameImage("Clu_run", "tex/characters/Clu_run_01.bmp", 116 * 8, 232, 8, 2, true, RGB(255, 0, 255));
	_player[BART].img = IMAGEMANAGER->addFrameImage("Bart_run", "tex/characters/Bart_run_01.bmp", 116 * 8, 232, 8, 2, true, RGB(255, 0, 255));
...
void loadingCharScene::update(void)
{
	...
	//로딩완료후 씬변경
	if (_loading->loadingDone() && _player[!_rand].x >= WINSIZEX)
	{
		this->loadingEffect();
		_alpha += 5;
		if (_alpha >= 255)
...
void loadingCharScene::render(void)
{
	...
	_player[_rand].img->frameRender(getMemDC(), _player[_rand].x, _player[_rand].y, _index, 0);
...
void loadingCharScene::loadingImage()
{
	//CLU
	...
	//MONSTERS
	_loading->loadFrameImage("Sandworm_idle", "tex/monsters/Sandworm_01.bmp", 8532, 328, 27, 2, true, RGB(255, 0, 255));
	_loading->loadFrameImage("Sandworm_idle_shadow", "tex/monsters/Sandworm_shadow_01.bmp", 8532, 328, 27, 2, true, RGB(255, 0, 255));
	_loading->loadFrameImage("Sandworm_walk", "tex/monsters/Sandworm_walk_01.bmp", 1896, 328, 6, 2, true, RGB(255, 0, 255));
	_loading->loadFrameImage("Sandworm_attack", "tex/monsters/Sandworm_attack_01.bmp", 6320, 328, 20, 2, true, RGB(255, 0, 255));
	...
	_loading->loadFrameImage("Eagle_idle", "tex/monsters/Eagle_idle_01.bmp", 1424, 336, 8, 2, true, RGB(255, 0, 255));
	_loading->loadFrameImage("Eagle_takeFlight", "tex/monsters/Eagle_takeFlight_01.bmp", 1424, 336, 8, 2, true, RGB(255, 0, 255));
	_loading->loadFrameImage("Eagle_fly", "tex/monsters/Eagle_fly_01.bmp", 1424, 336, 8, 2, true, RGB(255, 0, 255));
	_loading->loadFrameImage("Eagle_hit", "tex/monsters/Eagle_hit_01.bmp", 1424, 336, 8, 2, true, RGB(255, 0, 255));
	_loading->loadFrameImage("Eagle_attack", "tex/monsters/Eagle_attack_01.bmp", 1246, 336, 8, 2, true, RGB(255, 0, 255));
	_loading->loadFrameImage("Thief_Boomerang_walk", "tex/monsters/Thief_Boomerang_walk_01.bmp", 1500, 156, 15, 2, true, RGB(255, 0, 255));
	_loading->loadFrameImage("Thief_Boomerang_walk_shadow", "tex/monsters/Thief_Boomerang_walk_shadow_01.bmp", 1500, 156, 15, 2, true, RGB(255, 0, 255));
	_loading->loadFrameImage("Thief_Boomerang_hit", "tex/monsters/Thief_Boomerang_hit_01.bmp", 1500, 156, 15, 2, true, RGB(255, 0, 255));
	_loading->loadFrameImage("Thief_Boomerang_attack", "tex/monsters/Thief_Boomerang_attack_01.bmp", 400, 156, 4, 2, true, RGB(255, 0, 255));
	_loading->loadFrameImage("Thief_Boomerang_attack_shadow", "tex/monsters/Thief_Boomerang_attack_shadow_01.bmp", 400, 156, 4, 2, true, RGB(255, 0, 255));
	_loading->loadFrameImage("Mask_walk", "tex/monsters/Mask_walk_01.bmp", 1280, 172, 10, 2, true, RGB(255, 0, 255));
	_loading->loadFrameImage("Mask_hit", "tex/monsters/Mask_hit_01.bmp", 1280, 172, 10, 2, true, RGB(255, 0, 255));
	_loading->loadFrameImage("bloodBlob", "tex/fx/Blood_Blob_01.bmp", 324, 132, 6, 2, true, RGB(255, 0, 255));
	_loading->loadImage("boomerang", "tex/monsters/Boomerang.bmp", 42, 42, true, RGB(255, 0, 255));
	...
	_loading->loadImage("fx_smoke1", "tex/fx/Smoke_01.bmp", 118, 110, true, RGB(255, 0, 255));
	_loading->loadImage("fx_smoke2", "tex/fx/Smoke_02.bmp", 118, 110, true, RGB(255, 0, 255));
	_loading->loadImage("fx_smoke3", "tex/fx/Smoke_03.bmp", 118, 110, true, RGB(255, 0, 255));
	_loading->loadImage("fx_smoke4", "tex/fx/Smoke_04.bmp", 118, 110, true, RGB(255, 0, 255));
	_loading->loadImage("fx_smoke5", "tex/fx/Smoke_05.bmp", 118, 110, true, RGB(255, 0, 255));
	...
	_loading->loadImage("autotile_darkbrown1", "tex/map/autoTile_darkbrown_01.bmp", 1080, 475, true, RGB(255, 0, 255));
	_loading->loadImage("autotile_darkbrown2", "tex/map/autoTile_darkbrown_02.bmp", 1677, 715, true, RGB(255, 0, 255));
	_loading->loadImage("autotile_darkbrown3", "tex/map/autoTile_darkbrown_03.bmp", 2274, 716, true, RGB(255, 0, 255));
	_loading->loadImage("autotile_darkbrown4", "tex/map/autoTile_darkbrown_04.bmp", 1079, 256, true, RGB(255, 0, 255));
	_loading->loadImage("autotile_darkbrown5", "tex/map/autoTile_darkbrown_05.bmp", 1320, 597, true, RGB(255, 0, 255));
	_loading->loadImage("autotile_orange1", "tex/map/autoTile_orange_02.bmp", 1200, 357, true, RGB(255, 0, 255));
	_loading->loadImage("autotile_orange2", "tex/map/autoTile_orange_03.bmp", 1800, 477, true, RGB(255, 0, 255));
	_loading->loadImage("autotile_orange3", "tex/map/autoTile_orange_04.bmp", 1199, 237, true, RGB(255, 0, 255));
	_loading->loadImage("autotile_orange4", "tex/map/autoTile_orange_05.bmp", 1078, 356, true, RGB(255, 0, 255));
	_loading->loadImage("autotile_orange5", "tex/map/autoTile_orange_06.bmp", 1078, 116, true, RGB(255, 0, 255));
	_loading->loadImage("autotile_orange6", "tex/map/autoTile_orange_07.bmp", 1195, 356, true, RGB(255, 0, 255));
	_loading->loadImage("autotile_orange7", "tex/map/autoTile_orange_08.bmp", 1436, 241, true, RGB(255, 0, 255));
	_loading->loadImage("autotile_orange8", "tex/map/autoTile_orange_09.bmp", 840, 240, true, RGB(255, 0, 255));
	_loading->loadImage("autotile_lightorange1", "tex/map/autoTile_lightorange_02.bmp", 1200, 357 + 120, true, RGB(255, 0, 255));
	_loading->loadImage("autotile_lightorange2", "tex/map/autoTile_lightorange_03.bmp", 1800, 477 + 120, true, RGB(255, 0, 255));
	_loading->loadImage("autotile_lightorange3", "tex/map/autoTile_lightorange_04.bmp", 1199, 237 + 120, true, RGB(255, 0, 255));
	_loading->loadImage("autotile_lightorange4", "tex/map/autoTile_lightorange_05.bmp", 1078, 356 + 120, true, RGB(255, 0, 255));
	_loading->loadImage("autotile_lightorange5", "tex/map/autoTile_lightorange_06.bmp", 1078, 116 + 120, true, RGB(255, 0, 255));
	_loading->loadImage("autotile_lightorange6", "tex/map/autoTile_lightorange_07.bmp", 1195, 356 + 120, true, RGB(255, 0, 255));
	_loading->loadImage("autotile_lightorange7", "tex/map/autoTile_lightorange_08.bmp", 1436, 241 + 120, true, RGB(255, 0, 255));
	_loading->loadImage("autotile_lightorange8", "tex/map/autoTile_lightorange_09.bmp", 840, 240 + 120, true, RGB(255, 0, 255));
	_loading->loadImage("autotile_back1", "tex/map/autoTile_back_01.bmp", 1196, 836, true, RGB(255, 0, 255));
	_loading->loadImage("autotile_back2", "tex/map/autoTile_back_02.bmp", 960, 720, true, RGB(255, 0, 255));
	_loading->loadImage("autotile_back3", "tex/map/autoTile_back_03.bmp", 1435, 1319, true, RGB(255, 0, 255));
	_loading->loadImage("autotile_back4", "tex/map/autoTile_back_04.bmp", 1078, 837, true, RGB(255, 0, 255));
	_loading->loadImage("autotile_back5", "tex/map/autoTile_back_05.bmp", 1673, 1678, true, RGB(255, 0, 255));
	_loading->loadImage("autotile_back6", "tex/map/autoTile_back_06.bmp", 1317, 1802, true, RGB(255, 0, 255));
}

//로딩사운드 함수(이곳에 사운드를 전부 넣어라)
void loadingCharScene::loadingSound()
{
...
void loadingCharScene::loadingEffect()
{
