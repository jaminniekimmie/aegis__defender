...
enum OBJECTTYPE
{
	CHIP_GREEN, CHIP_BLUE, CHIP_PURPLE, CHIP_WHITE, HEART_RED, HEART_YELLOW, ITEM_MINERAL, ITEM_BLUEFLOWER, BLOOMFLOWER, MINERAL, BLUEFLOWER, SPAWNER, DOOR_DNA_YELLOW_LEFT, DOOR_DNA_YELLOW_RIGHT, DOOR_DNA_BLUE_LEFT, DOOR_DNA_BLUE_RIGHT, DOOR_ELEVATOR, SWITCH_HOR, SWITCH_VERT, BUSH_SPIKES, VENT
};

enum OBJECTSTATE
{
	OBJECT_IDLE, OBJECT_MOVE, OBJECT_VANISH
};
